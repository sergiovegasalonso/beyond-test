using BeyondTest.Application.Common.Models;
using BeyondTest.Application.TodoItems.Commands.CreateTodoItem;
using BeyondTest.Application.TodoItems.Commands.DeleteTodoItem;
using BeyondTest.Application.TodoItems.Commands.UpdateTodoItem;
using BeyondTest.Application.TodoItems.Commands.UpdateTodoItemDetail;
using BeyondTest.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using Microsoft.AspNetCore.Http.HttpResults;

namespace BeyondTest.Web.Endpoints;
